...
module.exports = {
  ...
  parserOptions: {        // どの構文を使用しているかをESLintに伝えるためのオプション
    ecmaFeatures: {
      "jsx": true         // JSXをサポート
    },
    ecmaVersion: 12,      // https://eslint.org/docs/latest/user-guide/configuring/language-options
  ...
  rules: {
    "@typescript-eslint/naming-convention": [           // 変数の名付け規則
      "error",
